package ro.luci0.raspberryPi.services;
...
@Service
public class SystemInfoDisplayService {

    public void displayAllInfo() throws IOException, InterruptedException, ParseException {
